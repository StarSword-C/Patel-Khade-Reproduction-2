 ...
 * File: _coder_predictPKBNN_api.c
 *
...
/* Include Files */
#include "_coder_predictPKBNN_api.h"
#include "_coder_predictPKBNN_mex.h"
...
void predictPKBNN_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  int32_T soh_size[2];
  real32_T(*soh_data)[10];
  real32_T(*x)[4];
  st.tls = emlrtRootTLSGlobal;
  soh_data = (real32_T(*)[10])mxMalloc(sizeof(real32_T[10]));
  /* Marshall function inputs */
  x = emlrt_marshallIn(&st, emlrtAlias(prhs), "x");
  /* Invoke the target function */
  predictPKBNN(*x, *soh_data, soh_size);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*soh_data, soh_size);
}
...
void predictPKBNN_atexit(void)
{
  ...
  predictPKBNN_xil_terminate();
  predictPKBNN_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_predictPKBNN_api.c
 *
 * [EOF]
 */
